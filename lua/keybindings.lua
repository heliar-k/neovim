...
function M.setup()
  ...
  wk.add({
    ...
    { "<A-c>",      "<cmd>BDelete this<cr>",                           desc = "Close Current Buffer" },
    { "<A-p>",      "<cmd>BufferPick<cr>",                             desc = "Magic Buffer Pick" },
    { "<A-h>",      "<cmd>BufferPrevious<cr>",                         desc = "Go to Previous Buffer Tab" },
    { "<A-l>",      "<cmd>BufferNext<cr>",                             desc = "Go to Next Buffer Tab" },
    { "<A-1>",      "<cmd>BufferGoto 1<cr>",                           desc = "Go to No.1 Buffer Tab" },
    { "<A-2>",      "<cmd>BufferGoto 2<cr>",                           desc = "Go to No.2 Buffer Tab" },
    { "<A-3>",      "<cmd>BufferGoto 3<cr>",                           desc = "Go to No.3 Buffer Tab" },
    { "<A-4>",      "<cmd>BufferGoto 4<cr>",                           desc = "Go to No.4 Buffer Tab" },
    { "<A-5>",      "<cmd>BufferGoto 5<cr>",                           desc = "Go to No.5 Buffer Tab" },
    { "<A-6>",      "<cmd>BufferGoto 6<cr>",                           desc = "Go to No.6 Buffer Tab" },
